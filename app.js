    ...
    <div className="main" id="main">
        <div className="left_side">
            <div className="game_area">
                <div id="jeu" className="jeu" role="button" tabIndex="0" onKeyDown={e => moveSnake(e)}>
                  ...
                  {!nb_game && <div id="rule">Bienvenue!<br/>Pour afficher mon CV vous devez suffisament nourrir le serpent.<br/>Bonne chance!</div>}
                  {gameOver && !win && <div id="loose">Perdu!<br/>{(score<5) ? 'C\'etait trop dure?!' : 'Vous y etiez presque.'}<br/>Retentez vôtre chance.</div>}
        ...
        <div className="cv_area" tabIndex="0">
            <div className="cv_header">
                <div id="cv_pp" className="cv_pp" tabIndex="0"><img src="pp.png" alt="" id="pp"></img></div>
      ...
      <footer><a href="">À propos</a> <a href="">Autres projets</a> <a href="">Prochainement</a></footer>
      </div>
  );
};
